...
@Slf4j
@Service
public class WeatheryService implements IWeatheryService {

    @Value("${weather.api.key}")
    private String apiKey;
    @Override
    public WeatheryDTO getWeather(WeatheryDTO pDTO) throws Exception {
        ...
        String json= NetworkUtil.get(IWeatheryService.apiURL + apiParam);
        log.info("json : " + json);
        ...
        for (Map<String, Object> dailyMap : dailyList) {
            ...
            String day = DateUtil.getLongDataTime(dailyMap.get("dt"), "yyyy-MM-dd"); // 기준 날짜
            String sunrise = DateUtil.getLongDataTime(dailyMap.get("sunrise")); // 해뜨는 시간
            String sunset = DateUtil.getLongDataTime(dailyMap.get("sunset")); // 해지는 시간
            String moonrise = DateUtil.getLongDataTime(dailyMap.get("moonrise")); // 달뜨는 시간
            String moonset = DateUtil.getLongDataTime(dailyMap.get("moonset")); // 달지는 시간
        ...
        WeatheryDTO rDTO = new WeatheryDTO();
